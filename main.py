...
OWNER_ID = 8113432878 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [5840594311]

# ✅ Multiple AUTH CHANNELS allowed
AUTH_CHANNELS = [-1002605113558,-1002621188449]  # Add more channel IDs here
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/Jinx` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["Jinx"]))
